...
class ConlluReader():
    ...
    Methods:
        ...
        write_conllu_file(path: str, trees: list):
            Writes a list of tree structures to a file in CoNLLU format.

        remove_non_projective_trees(trees: list) -> list:
    ...
    def remove_non_projective_trees(self, trees) -> list:
        return [tree for tree in trees if self._is_projective(tree)]
    
    def write_conllu_file(self, path: str, trees: list) -> None:
        """
        Writes a list of tree structures to a file in CoNLLU format.
